...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SEAL_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("cdf55027-1209-57fc-8789-28745714751d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SEAL", artifacts_toml) for e in artifacts["SEAL"]]
...
if best_platform === nothing
    @debug("Unable to load SEAL; unsupported platform $(triplet(platform_key_abi()))")
else
